#include "SandUpDownTriRock.h"

namespace NrvSandUpDownTriRock {
    FULL_NERVE(SandUpDownTriRockNrvWait, SandUpDownTriRock, Wait);
    FULL_NERVE(SandUpDownTriRockNrvDown, SandUpDownTriRock, Down);
    FULL_NERVE(SandUpDownTriRockNrvRest, SandUpDownTriRock, Rest);
    FULL_NERVE(SandUpDownTriRockNrvUp, SandUpDownTriRock, Up);
    FULL_NERVE(SandUpDownTriRockNrvStop, SandUpDownTriRock, Stop);
};  // namespace NrvSandUpDownTriRock
...
void SandUpDownTriRock::init(const JMapInfoIter& rIter) {
    ...
    info.setupHitSensor();
    info.setupEffect(nullptr, nullptr);
